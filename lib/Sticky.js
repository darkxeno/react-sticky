...
var Sticky = function (_Component) {
  ...
  function Sticky() {
    ...
    return _ret = (_temp = (_this = _possibleConstructorReturn(this, (_ref = Sticky.__proto__ || Object.getPrototypeOf(Sticky)).call.apply(_ref, [this].concat(args))), _this), _this.state = {
      ...
      var placeholderClientRect = { x: 0, y: 0, width: 0, height: 0 };
      var contentClientRect = { x: 0, y: 0, width: 0, height: 0 };

      try {
        placeholderClientRect = _this.placeholder.getBoundingClientRect();
        contentClientRect = _this.content.getBoundingClientRect();
      } catch (error) {
